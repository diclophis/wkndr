...
ifeq ($(TARGET),desktop)
  ...
  EMSCRIPTEN_FLAGS=-gsource-map -s DEMANGLE_SUPPORT=1 -s ASSERTIONS=1 -s USE_ZLIB=1 -s SAFE_HEAP=0 -s WARN_UNALIGNED=1 -s ALLOW_MEMORY_GROWTH=0 -s NO_EXIT_RUNTIME=0 -O3 -s USE_GLFW=3 -s USE_WEBGL2=1 -s RESERVED_FUNCTION_POINTERS=64 #-s DISABLE_DEPRECATED_FIND_EVENT_TARGET_BEHAVIOR=1
