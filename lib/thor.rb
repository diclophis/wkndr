...
class Thor
  class Arguments #:nodoc: # rubocop:disable ClassLength
    ...
    log!(:gonna_split_0000000000000, args)
      ...
      args.each do |item|
        break if item.is_a?(String) && item[0] == "-"
        #TODO:item =~ /^-/
        arguments << item
      end
...
#      handle_no_method_error?(instance, e, caller) ? instance.class.handle_no_command_error(name) : (raise e)
  ...
  protected
    ...
    #    saned = error.backtrace #TODO: #sans_backtrace(error.backtrace, caller)
...
class Thor
  ...
  protected
    ...
    def create_command(meth) #:nodoc:
      ...
      if @usage && @desc
        ...
        puts "[WARNING] Attempted to create command #{meth.inspect} without usage or description. " \
             ...
             "no_commands{} block. Invoked from #{self.inspect}."
        false
      end
    end
    alias_method :create_task, :create_command
    ...
    def retrieve_command_name(args) #:nodoc:
      ...
      r = meth = args.first.to_s unless args.empty?
      r = args.shift if meth && (map[meth] || meth[0] != "-")
...
#  class DynamicCommand < Command
#    def initialize(name, options = nil)
#    log!(:DynComInit, name, options)
#      super(name.to_s, "A dynamically-generated command", name.to_s, name.to_s, options)
#    end
#
#    def run(instance, args = [])
#    log!(:DynComRun, instance, args)
#    raise "wtf"
#      #TODO?????
#      #TODO
#      #TODO
